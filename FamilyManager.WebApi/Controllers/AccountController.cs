...
using FamilyManager.WebApi.Results;
    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Perdida de contraseña", $"Por favor recupere su contraseña ingresando junto a la nueva contraseña este codigo de seguridad, donde se lo solicite {code}");
                return Ok();
            }
